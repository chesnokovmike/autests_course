...
class PublicTransport:
    def __init__(self, brand, engine_power, year, color, max_speed):
        """
        Экземпляр класса "Пассажирский транспорт"
        :param brand: марка транспорта
        :param engine_power: можность двигателы
    ...
    def info(self):
        """
        Вывод на печать марку, цвет, год выпуска и мощность
        """
...
class Bus(PublicTransport):
    ...
    def park(self):
        """
        Возвращает парк приписки
        :return park: парк приписки
        """
        return self.__park
    ...
    def park(self, value):
        """
        Устанавливает парк приписки, если он больше 1000 и меньше 9999
        :param value:
        """
...
class Tram(PublicTransport):
    ...
    def how_long(self):
        """
        Время прохождения машрута
        :return: время прохождения машрута
        """
