...
def scrabble(word):
    ...
    :param word: слово, в котором считать очки
    :return points: количество набранных очков
    """
    word_dict = {1: ("а", "в", "е", "ё", "и", "н", "о", "р", "с", "т"),
                 2: ("д", "к", "л", "м", "п", "у"),
                 3: ("б", "г", "ь", "я"),
                 4: ("й", "ы"),
                 5: ("ж", "з", "х", "ц", "ч"),
    ...
    points = 0
    for point, letter in word_dict.items():  # идем по словарю
        for sym in letter:  # идем по буквам в элементе словаря
            for character in word:  # идем по буквам в слове
                if character == sym:
                    points += point
    return points
