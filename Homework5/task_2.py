...
def repeats(our_str):
    """
    Добавляет после каждого символа строки количество повторов этого символа в формате "_n"
    :param our_str: строка
    :return new_str: отформатированная строка с количеством повторов символов
    """
    new_str = ''
    sym_dict = dict()
    for sym in our_str:
